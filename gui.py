...
class Example(QMainWindow):
    ...
    def initUI(self):
        ...
        font = QFont("Times New Roman", 48)
        font.setBold(True)
        welcomeLabel.setFont(font)
        welcomeLabel.setText("<html><center>Welcome,<br>Timetable Scheduler<br><br><b>TY59</b></center></html>")
        ...
        palette = QPalette()
        palette.setColor(QPalette.Background, QColor(173, 216, 230))  # Light blue with RGB values
        self.setPalette(palette)

        global professor
        professor = ''
        self.setGeometry(300, 400, 600, 600)
        self.setWindowTitle('Timetable Scheduler - Genetic Algorithm')
        QTimer.singleShot(7000, welcomeLabel.hide)
